...
var MonthPresenter = function (_CalendarPresenter) {
	...
	function MonthPresenter(document) {
		...
		_this.model = _this._createMonthModel();
		_this.view = _this._createMonthView(_this.document);
		_this.init();
		return _this;
	}
	...
	_createClass(MonthPresenter, [{
		...
		key: 'removeClassFromElements',
		value: function removeClassFromElements(classString, idsArray) {
			for (var i = 0, x = idsArray.length; i < x; i++) {
		...
		key: '_createMonthModel',
		value: function _createMonthModel() {
			return new MonthModel();
		}
	}, {
		key: '_createMonthView',
		value: function _createMonthView() {
		...
		key: '_getShortDayNamesFragment',
		value: function _getShortDayNamesFragment(fragment) {
		...
		value: function _getDatesFragment(fragment) {
...
var MonthView = function (_CalendarView) {
	...
	_createClass(MonthView, [{
		key: 'appendContent',
		value: function appendContent(contentFragment) {
   ...
   */
		...
		value: function removeClassFromElement(classString, elementId) {
